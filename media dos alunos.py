...
qt_media_maioresque_7 = 0
qt_medias_maioresque_7 = 0
...
while matricula != 0:
    ...
    # Contagem (v1): - - - - -
    if media > 7:
        qt_media_maioresque_7 += 1

    if media < 3:
        qt_medias_maioresque_7 += 1
...
print(f"Quantitade de médias maiores que 7: {qt_media_maioresque_7}")
print(f"Quantitade de médias menores que 3: {qt_medias_maioresque_7}")
